...
def update_collocation(model, data, N_adapt=100, type_adapt=0):
    """
    ...
    def get_new_collocation(model, eval_pts, N_adapt=100, type_adapt=0):
        ...
        if type_adapt==0:
            ...
            """
            print("Note that 'N_adapt' is ignored since the vanilla adaptive sampling (random sampling) is selected")
            return new_even
